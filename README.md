...
## Recent updates
Check out the <a href="https://github.com/NineNineFive/go-local-web-gui">go-local-web-gui (GOLW GUI) v0.4.10</a> and <a href="https://github.com/NineNineFive/go-local-web-example">go-local-web-example (GOLW Example) v0.4.10</a> repositories (developed by me), if you have any name suggestions for the project, please let me know by leaving an issue or sending me a message on LinkedIn.
